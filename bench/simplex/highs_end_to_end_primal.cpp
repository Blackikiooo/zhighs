// End-to-end HiGHS MPS + serial PRIMAL simplex reference runner.
// Forces simplex_strategy = 4 (primal) to match zhighs algorithm path.
#include "Highs.h"
#include <chrono>
#include <iomanip>
#include <iostream>
...
int main(int argc, char** argv) {
  ...
  highs.setOptionValue("simplex_strategy", 4);  // 4 = primal simplex
