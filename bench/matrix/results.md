...
| Kernel | 初始(S4) | Iter1 | Iter4 | Iter6 | 当前 | C++ | vs C++ |
|---|---:|---:|---:|---:|---:|---:|:---|
| clear output | 3,604 | — | 3,409 | — | 3,534 | 3,872 | **+9.6%** ✅ |
| CSC Ax dense | 150,707 | 159,726 | 144,094 | — | 142,776 | 236,191 | **+65.4%** ✅ |
| CSC Ax skip zero | 41,581 | — | — | — | 36,645 | 34,611 | -5.5% |
| CSC Ax sparse view | 21,772 | — | — | — | 19,675 | 18,279 | -7.1% |
| CSC sparse add | 15,498 | — | — | — | 15,357 | 13,702 | -10.8% |
| CSR Ax dense | 142,101 | 155,625 | 145,268 | 142,630 | 141,830 | 138,417 | -2.4% |
| CSC A^T x | 98,769 | — | 101,035 | — | 99,126 | 139,528 | **+40.8%** ✅ |
| **CSR A^T x** | **216,496** | **232,382** | **216,931** | **211,081** | **138,832** | **188,462** | **+35.7%** ✅ |
| alpha*A*x+y | 129,485 | 136,717 | 126,519 | — | 124,343 | 232,705 | **+87.1%** ✅ |
| compensated product | 494,266 | 257,836 | 257,126 | — | 270,283 | 378,600 | **+40.1%** ✅ |
| scaling | 167,910 | 129,426 | 113,904 | — | 112,823 | 163,614 | **+45.0%** ✅ |
| CSC→CSR into | 612,213 | — | 707,305 | 556,081 | 677,533 | 612,668 | -9.6% |
| transpose into | 421,671 | 699,026 | 697,553 | 545,461 | 649,520 | 926,156 | **+42.6%** ✅ |
| builder sorted | 896,878 | 951,331 | 834,979 | 795,907 | 816,591 | 814,793 | -0.2% |
| builder general | 1,988,615 | — | 1,993,024 | — | 1,963,244 | 3,451,314 | **+75.8%** ✅ |
| sparse accumulator | 199,593 | — | 202,284 | 166,627 | 186,252 | 138,819 | -25.5% |

**CSR A^T x** 是唯一在迭代 7 中通过手写汇编 (`asm/root.zig`) 实现跨越式改善的内核——最佳从 216µs 降至 139µs。
