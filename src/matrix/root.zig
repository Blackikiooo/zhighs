...
pub const SymbolicError = sparse_symbolic.SymbolicError;
pub const PivotKind = sparse_symbolic.PivotKind;
pub const SymbolicPlanView = sparse_symbolic.SymbolicPlanView;
pub const SymbolicWorkspace = sparse_symbolic.SymbolicWorkspace;
pub const KernelError = sparse_kernel.KernelError;
pub const SparsePivotChoice = sparse_kernel.PivotChoice;
pub const SparsePivotView = sparse_kernel.PivotView;
...
pub const CscTransformBuffers = transform_buffers.CscTransformBuffers;
...
pub const extractColumnsInto = slice_module.extractColumnsInto;
pub const extractColumnsIntoAssumeValid = slice_module.extractColumnsIntoAssumeValid;
pub const extractRows = slice_module.extractRows;
pub const extractRowsAssumeValid = slice_module.extractRowsAssumeValid;
pub const extractRowsInto = slice_module.extractRowsInto;
pub const extractRowsIntoAssumeValid = slice_module.extractRowsIntoAssumeValid;
pub const extractColumnRange = slice_module.extractColumnRange;
pub const extractColumnRangeInto = slice_module.extractColumnRangeInto;
...
pub const permuteInto = permutation.permuteInto;
pub const permuteIntoAssumeValid = permutation.permuteIntoAssumeValid;
pub const appendColumns = edit.appendColumns;
pub const appendColumnsInto = edit.appendColumnsInto;
pub const appendColumnsIntoAssumeValid = edit.appendColumnsIntoAssumeValid;
pub const appendRows = edit.appendRows;
pub const appendRowsInto = edit.appendRowsInto;
pub const appendRowsIntoAssumeValid = edit.appendRowsIntoAssumeValid;
pub const appendRowsFromCsr = edit.appendRowsFromCsr;
pub const appendRowsFromCsrAssumeValid = edit.appendRowsFromCsrAssumeValid;
pub const appendRowsFromCsrInto = edit.appendRowsFromCsrInto;
pub const appendRowsFromCsrIntoAssumeValid = edit.appendRowsFromCsrIntoAssumeValid;
pub const deleteColumns = edit.deleteColumns;
pub const deleteColumnsInto = edit.deleteColumnsInto;
pub const deleteRows = edit.deleteRows;
pub const deleteRowsInto = edit.deleteRowsInto;
