...
pub const Attr = enum {
    ...
    pub fn info(self: Attr) AttributeInfo {
        return switch (self) {
            // Model scalars
            .num_vars => comptime makeInfo(.int, .model, false),
            .num_constrs => comptime makeInfo(.int, .model, false),
            .num_nz => comptime makeInfo(.int, .model, false),
            .status => comptime makeInfo(.int, .model, false),
            .obj_val => comptime makeInfo(.double, .model, false),
            .obj_bound => comptime makeInfo(.double, .model, false),
            .obj_con => comptime makeInfo(.double, .model, true),
            .model_sense => comptime makeInfo(.int, .model, true),
            .is_mip => comptime makeInfo(.int, .model, false),
            .iter_count => comptime makeInfo(.int, .model, false),
            .node_count => comptime makeInfo(.int, .model, false),
            .bar_iter_count => comptime makeInfo(.int, .model, false),
            .num_qnz => comptime makeInfo(.int, .model, false),
            .num_sos => comptime makeInfo(.int, .model, false),
            .sol_count => comptime makeInfo(.int, .model, false),
            .model_name => comptime makeInfo(.string, .model, true),
            .status_label => comptime makeInfo(.string, .model, false),
            // Variable
            .lb => comptime makeInfo(.double, .variable, true),
            .ub => comptime makeInfo(.double, .variable, true),
            .obj => comptime makeInfo(.double, .variable, true),
            .v_type => comptime makeInfo(.char, .variable, true),
            .x => comptime makeInfo(.double, .variable, false),
            .rc => comptime makeInfo(.double, .variable, false),
            .var_name => comptime makeInfo(.string, .variable, true),
            .v_basis => comptime makeInfo(.int, .variable, true),
            .start => comptime makeInfo(.double, .variable, true),
            .p_start => comptime makeInfo(.double, .variable, true),
            .d_start => comptime makeInfo(.double, .variable, true),
            // Constraint
            .sense => comptime makeInfo(.char, .constraint, true),
            .rhs => comptime makeInfo(.double, .constraint, true),
            .constr_name => comptime makeInfo(.string, .constraint, true),
            .pi => comptime makeInfo(.double, .constraint, false),
            .slack => comptime makeInfo(.double, .constraint, false),
            .c_basis => comptime makeInfo(.int, .constraint, true),
            // IIS
            .iis_minimal => comptime makeInfo(.int, .model, false),
            .iis_lb => comptime makeInfo(.int, .variable, false),
            .iis_ub => comptime makeInfo(.int, .variable, false),
            .iis_sense => comptime makeInfo(.int, .constraint, false),
            .iis_rhs => comptime makeInfo(.int, .constraint, false),
            .iis_qconstr => comptime makeInfo(.int, .quadratic, false),
            .iis_genconstr => comptime makeInfo(.int, .general, false),
            .iis_sos => comptime makeInfo(.int, .sos, false),
            // MIP pool
            .pool_obj_val => comptime makeInfo(.double, .model, false),
            .pool_obj_bound => comptime makeInfo(.double, .model, false),
            .pool_solutions => comptime makeInfo(.int, .model, true),
            .pool_search_mode => comptime makeInfo(.int, .model, true),
            // MIP gap
            .mip_gap => comptime makeInfo(.double, .model, false),
            .mip_gap_abs => comptime makeInfo(.double, .model, false),
            // Sensitivity
            .sa_obj_low => comptime makeInfo(.double, .variable, false),
            .sa_obj_up => comptime makeInfo(.double, .variable, false),
            .sa_rhs_low => comptime makeInfo(.double, .constraint, false),
            .sa_rhs_up => comptime makeInfo(.double, .constraint, false),
            // Multi-objective
            .obj_n_val => comptime makeInfo(.double, .model, false),
            .obj_n_weight => comptime makeInfo(.double, .model, true),
            .obj_n_priority => comptime makeInfo(.int, .model, true),
            .obj_n_rel_tol => comptime makeInfo(.double, .model, true),
            .obj_n_abs_tol => comptime makeInfo(.double, .model, true),
            .obj_n_name => comptime makeInfo(.string, .model, true),
            // Count
            .num_bin_vars => comptime makeInfo(.int, .model, false),
            .num_int_vars => comptime makeInfo(.int, .model, false),
            .num_gen_constrs => comptime makeInfo(.int, .model, false),
            .num_q_constrs => comptime makeInfo(.int, .model, false),
            .num_pwl_obj => comptime makeInfo(.int, .model, false),
        };
    }
...
inline fn makeInfo(comptime value_type: ValueType, comptime scope: AttributeScope, comptime settable: bool) AttributeInfo {
